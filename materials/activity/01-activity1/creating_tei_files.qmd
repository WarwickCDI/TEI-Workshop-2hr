...
The pb element is part of the 'core elements'. James Cummings has an excellent set of slides about core components [here](https://slides.com/jamescummings/teistructure-core).
